...
{
    public static string? GetDesignerName(this EGrenade grenade) => grenade switch
    {
    ...
    public static string? GetProjectileName(this EGrenade grenade) => grenade switch
    {
    ...
    public static EGrenade? DesignerNameToEnum(this string designerName) => designerName switch
    {
